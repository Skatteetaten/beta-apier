...
Det skal etableres et nytt grensesnitt for å formidle utleggstrekk fra Skatteetaten til arbeidsgivere som har ansatte som skal ha trekk i lønn.
...
* SBS må spørre (poll) mot grensesnittet for å sjekke om det er nye utleggstrekk.
* Det vil etterhvert komme et grensesnitt der SBS kan motta notifikasjon (event) om at Skatteetaten har et nytt utleggstrekk til arbeidsgiver.
...
* Grensesnittet er egentlig en feed som viser nye utleggstrekk siden en inngitt forrige trekkid.
* Informasjonen i utleggstrekk er i formatet JSON.
